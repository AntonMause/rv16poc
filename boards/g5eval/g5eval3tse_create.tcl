...
#
# Microsemi Eval Kit for Microsemi MPF300TS-ES-1152 (2019)
#
...
#
set BOARD_NAME         g5eval3tse
set NAME_BASE          _rv16base
set NAME_BASE          $BOARD_NAME$NAME_BASE
#
set PROJ_DESCRIPTION   "G5 MPF300 TS ES Microsemi Eval Kit rv16"
...
new_project -location $PATH_BASE -name $NAME_BASE -project_description $PROJ_DESCRIPTION \
	...
	-family {PolarFire} -die {MPF300TS_ES} -package {FCG1152} -speed {-1} \
...
set_device -family {PolarFire} -die {MPF300TS_ES} -package {FCG1152} -speed {-1} \
