...
#
# Microsemi Video Kit for Microsemi for MPF300T-1FCG1152E
#
...
#
set BOARD_NAME         g5video3t
set NAME_BASE          _rv16base
set NAME_BASE          $BOARD_NAME$NAME_BASE
#
set PROJ_DESCRIPTION   "G5 MPF300T Microsemi Video Kit rv16"
...
new_project -location $PATH_BASE -name $NAME_BASE -project_description $PROJ_DESCRIPTION \
	...
	-family {PolarFire} -die {MPF300T} -package {FCG1152} -speed {-1} \
...
set_device -family {PolarFire} -die {MPF300T} -package {FCG1152} -speed {-1} \
