...
#
# Virtual Eval Kit for Microsemi M2S025T-FCSG158 (2022)
...
# 
set BOARD_NAME         g4fcsg2s
set NAME_BASE          _rv16base
set NAME_BASE          $BOARD_NAME$NAME_BASE
#
set PROJ_DESCRIPTION   "G4 M2S025 Virtual fcsg158 Kit rv16"
...
new_project -location $PATH_BASE -name $NAME_BASE -project_description $PROJ_DESCRIPTION \
	...
	-family {SmartFusion2} -die {M2S025T} -package {FCSG158} -speed {STD} -die_voltage {1.2} \
	-part_range {IND} -adv_options {IO_DEFT_STD:LVCMOS 2.5V} \
	-adv_options {RESTRICTPROBEPINS:1} -adv_options {RESTRICTSPIPINS:0} \
	-adv_options {TEMPR:IND} -adv_options {UNUSED_MSS_IO_RESISTOR_PULL:None} \
