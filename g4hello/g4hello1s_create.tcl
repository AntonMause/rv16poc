...
# 
set BOARD_NAME         g4hello1s
set NAME_BASE          _rv16base
set NAME_BASE          $BOARD_NAME$NAME_BASE
#
set PROJ_DESCRIPTION   "G4 M2S010 Microchip Hello FPGA rv16"
...
new_project -location $PATH_BASE -name $NAME_BASE -project_description $PROJ_DESCRIPTION \
	...
	-family {SmartFusion2} -die {M2S010} -package {256 VF} -speed {STD} -die_voltage {1.2} \
