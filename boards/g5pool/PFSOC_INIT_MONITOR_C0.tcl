# Exporting core PFSOC_INIT_MONITOR_C0 to TCL
# Exporting Create design command for core PFSOC_INIT_MONITOR_C0
create_and_configure_core -core_vlnv {Microsemi:SgCore:PFSOC_INIT_MONITOR:1.0.101} -component_name {PFSOC_INIT_MONITOR_C0} -params {\
...
# Exporting core PFSOC_INIT_MONITOR_C0 to TCL done
