...
# 
set BOARD_NAME         g4rt15es
set NAME_BASE          _rv16base
set NAME_BASE          $BOARD_NAME$NAME_BASE
#
set PROJ_DESCRIPTION   "RTG4 150 ES DevKit rv16"
...
new_project -location $PATH_BASE -name $NAME_BASE -project_description $PROJ_DESCRIPTION \
	...
	-family {RTG4} -die {RT4G150_ES} -package {1657 CG} -speed {STD} -die_voltage {1.2} -part_range {MIL} \
