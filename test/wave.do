...
add wave -noupdate /rv16poc_tb/rv16poc_0/s_dec_slt
...
add wave -noupdate /rv16poc_tb/rv16poc_0/s_mac_uns
...
WaveRestoreCursors {{Cursor 1} {18935000000 fs} 0}
...
update
WaveRestoreZoom {18895312500 fs} {19092187500 fs}
